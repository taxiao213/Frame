 ...
 */
public abstract class BaseApi<T extends BaseResultEntity> implements Func1<T, T> {
    //rx生命周期管理
    ...
    /*基础url*/
    private String baseUrl = "http://192.168.0.33:8080/his-portal/";
    ...
    public T call(T t) {
        if (t.getResCode() != 0) {
            throw new HttpTimeException(t.getResMsg());
        }
        return t;
    }
}
